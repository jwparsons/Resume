...
\item Performed collaborative development on an iOS machine learning data extraction application for law enforcement (Swift, CocoaPods, UIKit, UI/UX, CoreML, Interface Builder/Auto Layout, Thread Management).
...
\runsubsection{LoopHole}
\descript{| Unity}
\location{Feb 2017 | Tallahassee, FL}
